...
namespace FirstSchool.Controllers
{
    public class EscuelaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Since,Dirección,Ciudad,Pais,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Since,Dirección,Ciudad,Pais,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
